...
int salir(int a){
    ...
    gotoxy(47,24);printf("Ingrese 1 para continuar el programa: ");
    gotoxy(84,24);scanf("%d",&a);
    return(a);
}
void borrar2(){
    gotoxy(b1,b2);printf("             ");
...
void personal_elegido(int elec){
...
void ingresar_personal(){
    int postul,i2,eleccion,conterror=0;
    k2=5;j2=0;
                     //1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890
    ...
    do{
        ...
        borrar2();
        j2++;
        gotoxy(33,22);printf("Ingrese 1 para terminar la postulacion: ");
        gotoxy(73,22);scanf("%d",&postul);
        b1=73;b2=22;
        borrar2();
    }while(postul!=1);
